...
# Opsamling
Java og C# er to meget ens sprog. De fleste forskelle jeg har fundet ligger i primært i systaks, konventioner for navngivning og selvfølgelig i at enslydende funktionalitet ikke er implementeret ens, såsom:
